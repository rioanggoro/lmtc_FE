        ...
        {partners.map((partner) => (
          ...
          >
            ...
            <div className="flex w-2/3 flex-col justify-between p-6">
              ...
              <button
                className="mt-4 w-full rounded-lg bg-orange-500 px-4 py-2 text-white transition hover:bg-orange-600"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="relative mx-4 max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6">
            ...
            {selectedPartner.hasMap && (
              <div className="mt-4 rounded border border-gray-200 bg-gray-50 p-2 text-center text-sm text-blue-600 hover:underline">
